...
def main():
    ...
    # valdir = os.path.join(opt.data, 'images/val2017')
    # annFile = os.path.join(opt.data, 'annotations/instances_val2017.json')
    # normalize = transforms.Normalize(mean=[0.485, 0.456, 0.406],
    #                                  std=[0.229, 0.224, 0.225])

    # val_loader = torch.utils.data.DataLoader(
    #     CocoDetection(valdir, annFile, transforms.Compose([
    ...
    if use_weight_mp:
        ...
        if use_weight_mp and not use_act_mp:
            ...
            torch.save(model.state_dict(), "/root/yixiaojie/CNN-Quantization/quant_output_random/yolov10s_w8a8/mixed_precision.pth")
